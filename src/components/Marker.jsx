...
<tr>
    <td>
        <p style={{fontSize: 15, fontFamily:'Arial', float:'left'}}>website</p>
    </td>
    <td>
        <p style={{fontSize: 15, fontFamily:'Arial', float:'right'}}>{point.properties.website}</p>
    </td>
</tr>
<tr>
    <td>
        <p style={{fontSize: 15, fontFamily:'Arial', float:'left'}}>telephone</p>
    </td>
    <td>
        <p style={{fontSize: 15, fontFamily:'Arial', float:'right'}}>{point.properties.telephone}</p>
    </td>
</tr>
</table>
} else {
...
<Marker position={relative} icon={orangeIcon} key={"key" + point.geometry.coordinates + point.properties.id}
